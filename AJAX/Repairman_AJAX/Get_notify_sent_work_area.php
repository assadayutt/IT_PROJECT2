...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['area_id'])) {
    ...
    try {
        ...
        $stmt = $conn->prepare("SELECT Area_repair.area_detail, Area_repair.area_problem, Area_repair.area_address ,User.user_linetoken, Repairman.repairman_name, Area_Assign_work.assign_datecomp, Area_Assign_work.date_complete
        FROM Area_repair 
        ...
        if ($result && isset($result['user_linetoken'])) {
            ...
            $date_complete = $result['date_complete'];
