           ...
           if (count($result) > 0) {
            ...
            ?>
                        ...
                        <div class="pagination">
                            <?php
                        $totalItems = $conn->query("SELECT COUNT(*) FROM Equipment_repair  WHERE status_id in (2,3,4,5,6,7)")->fetchColumn();
            ...
            <div class="card card-default">
                ...
                <div class="row">
                    <div class="card-body">
                        ...
                        <div class="pagination">
                            <?php
                        $totalItems = $conn->query("SELECT COUNT(*) FROM Area_repair WHERE status_id in (2,3,4,5,6,7)")->fetchColumn();
                        $totalPages = ceil($totalItems / $itemsPerPage);
