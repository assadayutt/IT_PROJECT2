...
function showPopup_repair(data) {
    ...
    if (data.repair_imagesbefor) {
        $("#repair_imagesbefor_display1").attr("src", data.repair_imagesbefor);
    } else {
        $("#repair_imagesbefor_display1").attr("src",
    ...
    if (data.image_after) {
        ...
        $("#repair_imagesafter_display1").attr("src",
            "../../Images/blank-image.jpeg");
    }
...
function history_repair(repair_id) {
    ...
    $.ajax({
        url: location.origin + "/project/AJAX/User_AJAX/Get_repair_complete_history.php",
        method: "POST",
        data: {
            repair_id: repair_id
        },
...
<body>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <div class="rating-box">
                                        <header>คะแนนที่ให้ <span id="Score"></span> คะแนน</header>
                                        <div class="stars">
    ...
    function history_area(area_id) {
        ...
        $.ajax({
            url: location.origin + "/project/AJAX/User_AJAX/Get_area_complete_history.php",
            method: "POST",
            data: {
                area_id: area_id
            },
