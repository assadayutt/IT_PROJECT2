...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    try {
        $sql = "INSERT INTO Equipment(equipment_name, equipment_number, equipment_brand, equipment_model, equipment_color, equipment_detail, equipment_serial, equipment_status, equipment_price, equipment_exp, equipment_owner, equipment_count, equipment_address, equipment_sale, type_id) 
                VALUES (:equipment_name, :equipment_number, :equipment_brand, :equipment_model, :equipment_color, :equipment_detail, :equipment_serial, :equipment_status, :equipment_price, :equipment_exp, :equipment_owner, :equipment_count, :equipment_address, :equipment_sale, :type_id)";
